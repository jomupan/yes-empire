...
export default function NewInspection({ nav, setSelId }) {
  ...
  return (
    <div style={{ background:iosBg, minHeight:"100vh", paddingBottom:40 }}>
      ...
      {/* HEADER */}
      <div style={{
        background: white, padding:"72px 24px 20px",
        borderBottom:`1px solid ${iosSep}`,
        marginBottom:24,
      }}>
        ...
        <div style={{ fontWeight:800, fontSize:28, color:txt, letterSpacing:-0.8 }}>New Inspection</div>
        <div style={{ fontSize:14, color:sub, marginTop:4 }}>Fill in the property details</div>
      </div>
      ...
      <div style={{ padding:"0 16px", display:"flex", flexDirection:"column", gap:20 }}>
        ...
        {/* SECTION — Property */}
        <div style={{ background:white, borderRadius:20, padding:"20px 16px", boxShadow:"0 2px 12px rgba(0,0,0,0.06)" }}>
          <div style={{ fontSize:13, fontWeight:600, color:sub, letterSpacing:0.5, textTransform:"uppercase", marginBottom:16 }}>Property</div>
          <div style={{ display:"flex", flexDirection:"column", gap:14 }}>

    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ marginBottom:28 }}>
            ...
            <input
              ...
              style={{
                ...
                borderRadius:16,
                border:`1.5px solid ${error&&!name.trim()?"#FF3B30":"rgba(255,255,255,0.15)"}`,
          ...
          {/* REMEMBER ME */}
          <div style={{ display:"flex", alignItems:"center", justifyContent:"center", gap:10, marginBottom:20, cursor:"pointer" }} onClick={()=>setRemember(r=>!r)}>
            <div style={{
        ...
        {/* FOOTER */}
        <div style={{ color:"rgba(255,255,255,0.25)", fontSize:12, marginTop:28, textAlign:"center" }}>
